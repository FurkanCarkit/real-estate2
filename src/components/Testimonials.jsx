...
overflow-hidden' id='Testimonials'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='text-red-600'>Testimonails</span></h1>
    ...
    {testimonialsData.map((testimonial, index)=>(
        ...
        text-center'>
             ...
             <h2 className='text-xl text-gray-700 front-medium'>{testimonial.name}</h2>
             ...
             <p className='text-gray-600'>{testimonial.text}
             </p>
          </div>
    ))}
      </div>
